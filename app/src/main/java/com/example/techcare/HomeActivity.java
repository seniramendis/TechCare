...
public class HomeActivity extends AppCompatActivity {
    ...
    private void setupPopularServices() {
        ...
        // 1. Screen Repair
        services.add(new PopularService("Screen Repair", "https://images.unsplash.com/photo-1581092921461-39b9d08a9b2a?auto=format&fit=crop&w=600&q=80"));
        // 2. Battery Fix
        services.add(new PopularService("Battery Fix", "https://images.unsplash.com/photo-1550041473-d296a1a8ec02?auto=format&fit=crop&w=600&q=80"));
        // 3. Virus Cleanup
        services.add(new PopularService("Virus Cleanup", "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=600&q=80"));
        // 4. Data Recovery
        services.add(new PopularService("Data Recovery", "https://images.unsplash.com/photo-1558494949-ef526b0042a0?auto=format&fit=crop&w=600&q=80"));
        // 5. OS Install
        services.add(new PopularService("OS Install", "https://images.unsplash.com/photo-1593642702749-b7d2a804fbcf?auto=format&fit=crop&w=600&q=80"));
    ...
    static class PopularService {
        ...
        PopularService(String name, String imageUrl) { this.name = name; this.imageUrl = imageUrl; }
    }
